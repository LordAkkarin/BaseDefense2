 ...
 */
package basedefense.common.block;
...
public abstract class AbstractBlock extends Block {
        private final ISimpleBlockRenderingHandler renderType;

        protected AbstractBlock (Material p_i45394_1_) {
                super (p_i45394_1_);

                this.renderType = registerRenderType ();
        }
